...
class npc_2(pygame.sprite.Sprite):
    ...
    def __init__(self, game, x, y):
        ...
        self.groups = self.game.all_sprites, self.game.npc_2
        ...
        self.image = self.game.npc_2_spritesheet.get_sprite(32, 0, self.width, self.height)
    ...
    def update(self):
        ...
        # call the movement, player_collision and animate function
        self.movement()
        self.animate()
    ...
    def animate(self):
        ...
        up_animations = [self.game.npc_2_spritesheet.get_sprite(0, 0, self.width, self.height),
                           self.game.npc_2_spritesheet.get_sprite(32, 0, self.width, self.height),
                           self.game.npc_2_spritesheet.get_sprite(64, 0, self.width, self.height)]

        left_animations = [self.game.npc_2_spritesheet.get_sprite(0, 32, self.width, self.height),
                           self.game.npc_2_spritesheet.get_sprite(32, 32, self.width, self.height),
                           self.game.npc_2_spritesheet.get_sprite(64, 32, self.width, self.height)]

        right_animations = [self.game.npc_2_spritesheet.get_sprite(0, 64, self.width, self.height),
                            self.game.npc_2_spritesheet.get_sprite(32, 64, self.width, self.height),
                            self.game.npc_2_spritesheet.get_sprite(64, 64, self.width, self.height)]

        down_animations = [self.game.npc_2_spritesheet.get_sprite(0, 98, self.width, self.height),
                         self.game.npc_2_spritesheet.get_sprite(32, 98, self.width, self.height),
                         self.game.npc_2_spritesheet.get_sprite(64, 98, self.width, self.height)]
        ...
        if self.facing == "down":
            if self.y_change == 0:
                self.image = self.game.npc_2_spritesheet.get_sprite(0, 0, self.width, self.height)
            else:
    ...
    def player_collision(self):
        ...
        Returns:
            boolean value of either True or False based on whether or not npc and player sprite collided
        '''
